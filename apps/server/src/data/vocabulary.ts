...
export const wordSeeds: WordSeed[] = [
  ...
  { word: 'amber', definition: 'a golden-yellow color or fossilized tree resin', exampleSentence: 'Amber light made the lobby feel warm.', difficulty: 'easy', partOfSpeech: 'noun' },
  ...
  { word: 'bloom', definition: 'to produce flowers or to grow strongly', exampleSentence: 'Good habits bloom with daily practice.', difficulty: 'easy', partOfSpeech: 'verb' },
  ...
  { word: 'cheer', definition: 'a shout of encouragement or happiness', exampleSentence: 'A win should bring a cheer to the room.', difficulty: 'easy', partOfSpeech: 'noun' },
  ...
  { word: 'glow', definition: 'to shine with a soft steady light', exampleSentence: 'The tiles glow brighter after each success.', difficulty: 'easy', partOfSpeech: 'verb' },
  { word: 'hush', definition: 'a quiet or silent state', exampleSentence: 'The room fell into a hush before the final answer.', difficulty: 'easy', partOfSpeech: 'noun' },
  { word: 'jolt', definition: 'a sudden shock or quick movement', exampleSentence: 'A tricky clue can jolt your focus awake.', difficulty: 'easy', partOfSpeech: 'verb' },
  { word: 'mist', definition: 'a cloud of tiny water droplets in the air', exampleSentence: 'Soft mist made the background dreamy.', difficulty: 'easy', partOfSpeech: 'noun' },
  { word: 'nova', definition: 'a star that suddenly becomes much brighter', exampleSentence: 'The new feature felt like a nova in the interface.', difficulty: 'easy', partOfSpeech: 'noun' },
  ...
  { word: 'aurora', definition: 'a colorful natural light display in the sky', exampleSentence: 'The palette looked like an aurora at dawn.', difficulty: 'medium', partOfSpeech: 'noun' },
  ...
  { word: 'lantern', definition: 'a portable lamp with a protective case', exampleSentence: 'The hint served as a lantern in the dark round.', difficulty: 'medium', partOfSpeech: 'noun' },
